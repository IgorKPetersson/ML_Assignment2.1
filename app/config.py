...
HUB_MAX_MESSAGES_SENT = int(os.getenv("HUB_MAX_MESSAGES_SENT", "10"))
HUB_MAX_MODEL_CALLS = int(os.getenv("HUB_MAX_MODEL_CALLS", "40"))
HUB_MAX_TOTAL_TOKENS = int(os.getenv("HUB_MAX_TOTAL_TOKENS", "100000"))
